...
(function() {
  ...
  root.Kache.clearStore = function() {
  ...
  root.Kache.clearExpireds = function() {
  ...
  root.Kache.disable = function() {
    LocalStore.disable();
    MemoryStore.disable();
    return !(LocalStore.isEnabled() && MemoryStore.isEnabled());
  };
