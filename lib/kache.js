...
(function() {
  ...
  Store = (function(_super) {
    ...
    function Store(kwargs) {
      ...
      if (kwargs.logPrefix) this.logPrefix = kwargs.logPrefix;
      ...
      if (!kwargs['load']) throw 'Cannot load cache store';
      this._ = kwargs.load();
  ...
  MemoryStore = (function(_super) {
    ...
    function MemoryStore(namespace, timeout, attrs) {
      var kwargs;
      ...
      MemoryStore.__super__.constructor.call(this, kwargs);
    }
  ...
  LocalStore = (function(_super) {
    ...
    function LocalStore(namespace, timeout, attrs) {
      var kwargs;
      this.namespace = namespace;
      this.timeout = timeout;
      this.attrs = attrs;
      ...
      LocalStore.__super__.constructor.call(this, kwargs);
    }
