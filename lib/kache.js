...
(function() {
  var DefaultKacheConfig, DefaultStore, LocalStore, Log, MemoryStore, Module, Store, count, isExpired, isNumber, moduleKeywords, noop, root, time, _base, _base2, _base3,
  ...
  MemoryStore = (function(_super) {
    ...
    function MemoryStore(namespace, timeout, atts) {
      ...
      this.timeout = timeout;
      this.atts = atts;
      this._ = (_ref = (_base4 = this.store)[_name = this.namespace]) != null ? _ref : _base4[_name] = {};
      this.logPrefix = 'MemoryStore';
